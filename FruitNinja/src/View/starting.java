	   ...
	   root.getChildren().add(background);
	    ...
	    level1b.setOnAction(new EventHandler<ActionEvent>()  {
			...
			public void handle(ActionEvent event) {
				...
				ImageView ScoreDelay = new ImageView("file:scores.jpeg");
				ScoreDelay.setLayoutX(460);
				ScoreDelay.setLayoutY(200);
				ScoreDelay.setFitWidth(470);
				ScoreDelay.setFitHeight(400);
			//	ScoreDelay.setVisible(true);
				root.getChildren().add(ScoreDelay);
			    Text lastScore = new Text("Your last score\r\n               "+game.getReader().readScore());
			    lastScore.setFont(Font.font(Font.getFontNames().get(0), FontWeight.EXTRA_BOLD, 30));
			    lastScore.setLayoutX(600);
			    lastScore.setLayoutY(400);
