...
public class LevelTwo implements Observer {
	...
	public void update() {
		score = game.getScore();
		game.getWriter().writeScore2(score);
		ShowScore();
	}
	...
	public void prepareReset() {
		...
		exitButton.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				timeline.stop();
				game.getWriter().writeScore2(game.getScore());
	...
	public void PrepareLevelTwo() {
		...
		ImageView life1 = new ImageView("file:lives.png");
		life1.setFitWidth(60);
		life1.setFitHeight(60);
		life1.setLayoutX(1300);
		ImageView life2 = new ImageView("file:lives.png");
		life2.setFitWidth(60);
		life2.setFitHeight(60);
		life2.setLayoutX(1300 - 50);
		ImageView life3 = new ImageView("file:lives.png");
